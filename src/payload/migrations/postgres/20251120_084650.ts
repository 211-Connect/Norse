...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TYPE "public"."_locales" ADD VALUE 'pt' BEFORE 'ru';
  ALTER TYPE "public"."enum_tenants_enabled_locales" ADD VALUE 'pt' BEFORE 'ru';
  ALTER TYPE "public"."enum_tenants_default_locale" ADD VALUE 'pt' BEFORE 'ru';
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  CREATE TYPE "public"."_locales" AS ENUM('am', 'ar', 'de', 'en', 'es', 'fi', 'fil', 'fr', 'hi', 'hr', 'ht', 'ko', 'ne', 'pl', 'ru', 'so', 'sw', 'uk', 'vi', 'yue', 'zh-Hans', 'zh-Hant');
  ...
  CREATE TYPE "public"."enum_tenants_enabled_locales" AS ENUM('am', 'ar', 'de', 'en', 'es', 'fi', 'fil', 'fr', 'hi', 'hr', 'ht', 'ko', 'ne', 'pl', 'ru', 'so', 'sw', 'uk', 'vi', 'yue', 'zh-Hans', 'zh-Hant');
  ...
  CREATE TYPE "public"."enum_tenants_default_locale" AS ENUM('am', 'ar', 'de', 'en', 'es', 'fi', 'fil', 'fr', 'hi', 'hr', 'ht', 'ko', 'ne', 'pl', 'ru', 'so', 'sw', 'uk', 'vi', 'yue', 'zh-Hans', 'zh-Hant');
