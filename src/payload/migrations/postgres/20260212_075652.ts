...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TYPE "public"."_locales" ADD VALUE 'rw' BEFORE 'ru';
  ALTER TYPE "public"."enum_tenants_enabled_locales" ADD VALUE 'rw' BEFORE 'ru';
  ALTER TYPE "public"."enum_tenants_default_locale" ADD VALUE 'rw' BEFORE 'ru';`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  CREATE TYPE "public"."_locales" AS ENUM('am', 'ar', 'de', 'en', 'es', 'fa', 'fi', 'fil', 'ff', 'fr', 'hi', 'hr', 'ht', 'ko', 'km', 'lo', 'mww', 'ne', 'om', 'or', 'pl', 'ps', 'prs', 'pt', 'ru', 'so', 'sw', 'uk', 'vi', 'yue', 'zh-Hans', 'zh-Hant');
  ...
  CREATE TYPE "public"."enum_tenants_enabled_locales" AS ENUM('am', 'ar', 'de', 'en', 'es', 'fa', 'fi', 'fil', 'ff', 'fr', 'hi', 'hr', 'ht', 'ko', 'km', 'lo', 'mww', 'ne', 'om', 'or', 'pl', 'ps', 'prs', 'pt', 'ru', 'so', 'sw', 'uk', 'vi', 'yue', 'zh-Hans', 'zh-Hant');
  ...
  CREATE TYPE "public"."enum_tenants_default_locale" AS ENUM('am', 'ar', 'de', 'en', 'es', 'fa', 'fi', 'fil', 'ff', 'fr', 'hi', 'hr', 'ht', 'ko', 'km', 'lo', 'mww', 'ne', 'om', 'or', 'pl', 'ps', 'prs', 'pt', 'ru', 'so', 'sw', 'uk', 'vi', 'yue', 'zh-Hans', 'zh-Hant');
