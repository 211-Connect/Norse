...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
    ...
    ALTER TABLE "rds_badges_list"
    ADD CONSTRAINT "rds_badges_list_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."rds" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "rds_badges_list_locales"
    ADD CONSTRAINT "rds_badges_list_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."rds_badges_list" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v_version_badges_list"
    ADD CONSTRAINT "_rds_v_version_badges_list_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_rds_v" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v_version_badges_list_locales"
    ADD CONSTRAINT "_rds_v_version_badges_list_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_rds_v_version_badges_list" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;
