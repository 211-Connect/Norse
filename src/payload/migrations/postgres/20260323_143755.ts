...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
    ...
    ALTER TABLE "rds"
    ADD COLUMN "header_position" "enum_rds_header_position" DEFAULT 'sticky';

    ALTER TABLE "rds"
    ADD COLUMN "search_use_custom_card_layout" boolean DEFAULT FALSE;

    ALTER TABLE "_rds_v"
    ADD COLUMN "version_header_position" "enum__rds_v_version_header_position" DEFAULT 'sticky';

    ALTER TABLE "_rds_v"
    ADD COLUMN "version_search_use_custom_card_layout" boolean DEFAULT FALSE;

    ALTER TABLE "rds_search_card_layout"
    ADD CONSTRAINT "rds_search_card_layout_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."rds" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "rds_search_card_layout_locales"
    ADD CONSTRAINT "rds_search_card_layout_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."rds_search_card_layout" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v_version_search_card_layout"
    ADD CONSTRAINT "_rds_v_version_search_card_layout_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_rds_v" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v_version_search_card_layout_locales"
    ADD CONSTRAINT "_rds_v_version_search_card_layout_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_rds_v_version_search_card_layout" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;
...
export async function down({
  ...
  await db.execute(sql`
    ...
    ALTER TABLE "rds"
    DROP COLUMN "header_position";

    ALTER TABLE "rds"
    DROP COLUMN "search_use_custom_card_layout";

    ALTER TABLE "_rds_v"
    DROP COLUMN "version_header_position";

    ALTER TABLE "_rds_v"
    DROP COLUMN "version_search_use_custom_card_layout";
