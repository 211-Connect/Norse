...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TYPE "public"."_locales" ADD VALUE 'lo' BEFORE 'ne';
  ALTER TYPE "public"."_locales" ADD VALUE 'mww' BEFORE 'ne';
  ALTER TYPE "public"."enum_tenants_enabled_locales" ADD VALUE 'lo' BEFORE 'ne';
  ALTER TYPE "public"."enum_tenants_enabled_locales" ADD VALUE 'mww' BEFORE 'ne';
  ALTER TYPE "public"."enum_tenants_default_locale" ADD VALUE 'lo' BEFORE 'ne';
  ALTER TYPE "public"."enum_tenants_default_locale" ADD VALUE 'mww' BEFORE 'ne';`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  CREATE TYPE "public"."_locales" AS ENUM('am', 'ar', 'de', 'en', 'es', 'fa', 'fi', 'fil', 'ff', 'fr', 'hi', 'hr', 'ht', 'ko', 'km', 'ne', 'om', 'or', 'pl', 'ps', 'prs', 'pt', 'ru', 'so', 'sw', 'uk', 'vi', 'yue', 'zh-Hans', 'zh-Hant');
  ...
  CREATE TYPE "public"."enum_tenants_enabled_locales" AS ENUM('am', 'ar', 'de', 'en', 'es', 'fa', 'fi', 'fil', 'ff', 'fr', 'hi', 'hr', 'ht', 'ko', 'km', 'ne', 'om', 'or', 'pl', 'ps', 'prs', 'pt', 'ru', 'so', 'sw', 'uk', 'vi', 'yue', 'zh-Hans', 'zh-Hant');
  ...
  CREATE TYPE "public"."enum_tenants_default_locale" AS ENUM('am', 'ar', 'de', 'en', 'es', 'fa', 'fi', 'fil', 'ff', 'fr', 'hi', 'hr', 'ht', 'ko', 'km', 'ne', 'om', 'or', 'pl', 'ps', 'prs', 'pt', 'ru', 'so', 'sw', 'uk', 'vi', 'yue', 'zh-Hans', 'zh-Hant');
