...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TYPE "public"."_locales" ADD VALUE 'gu' BEFORE 'hi';
  ALTER TYPE "public"."enum_tenants_enabled_locales" ADD VALUE 'gu' BEFORE 'hi';
  ALTER TYPE "public"."enum_tenants_default_locale" ADD VALUE 'gu' BEFORE 'hi';`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  CREATE TYPE "public"."_locales" AS ENUM('am', 'ar', 'de', 'en', 'es', 'fa', 'fj', 'fi', 'fil', 'ff', 'fr', 'hi', 'hr', 'ht', 'haw', 'ja', 'ko', 'km', 'lo', 'mww', 'ne', 'om', 'or', 'pl', 'ps', 'prs', 'pt', 'rw', 'ru', 'sm', 'so', 'sw', 'tl', 'uk', 'vi', 'yue', 'zh-Hans', 'zh-Hant');
  ...
  CREATE TYPE "public"."enum_tenants_enabled_locales" AS ENUM('am', 'ar', 'de', 'en', 'es', 'fa', 'fj', 'fi', 'fil', 'ff', 'fr', 'hi', 'hr', 'ht', 'haw', 'ja', 'ko', 'km', 'lo', 'mww', 'ne', 'om', 'or', 'pl', 'ps', 'prs', 'pt', 'rw', 'ru', 'sm', 'so', 'sw', 'tl', 'uk', 'vi', 'yue', 'zh-Hans', 'zh-Hant');
  ...
  CREATE TYPE "public"."enum_tenants_default_locale" AS ENUM('am', 'ar', 'de', 'en', 'es', 'fa', 'fj', 'fi', 'fil', 'ff', 'fr', 'hi', 'hr', 'ht', 'haw', 'ja', 'ko', 'km', 'lo', 'mww', 'ne', 'om', 'or', 'pl', 'ps', 'prs', 'pt', 'rw', 'ru', 'sm', 'so', 'sw', 'tl', 'uk', 'vi', 'yue', 'zh-Hans', 'zh-Hant');
