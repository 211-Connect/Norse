...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TYPE "public"."enum_left_col_items_component_id" ADD VALUE 'contacts' BEFORE 'phoneNumbers';
  ALTER TYPE "public"."enum_right_col_items_component_id" ADD VALUE 'contacts' BEFORE 'phoneNumbers';
  ALTER TYPE "public"."enum__left_col_v_items_component_id" ADD VALUE 'contacts' BEFORE 'phoneNumbers';
  ALTER TYPE "public"."enum__right_col_v_items_component_id" ADD VALUE 'contacts' BEFORE 'phoneNumbers';`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_left_col_items_component_id" AS ENUM('badges', 'resourceName', 'serviceName', 'address', 'transportation', 'accessibility', 'eligibility', 'requiredDocuments', 'hours', 'phoneNumbers', 'website', 'organizationUrl', 'email', 'languages', 'interpretationServices', 'applicationProcess', 'fees', 'serviceArea', 'description', 'categories', 'lastAssured', 'attribution', 'map', 'getDirections', 'organization', 'facets', 'separator', 'customAttribute');
