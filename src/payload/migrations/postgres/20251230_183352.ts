...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TYPE "public"."_locales" ADD VALUE 'ff' BEFORE 'fr';
  ALTER TYPE "public"."_locales" ADD VALUE 'om' BEFORE 'pl';
  ALTER TYPE "public"."enum_tenants_enabled_locales" ADD VALUE 'ff' BEFORE 'fr';
  ALTER TYPE "public"."enum_tenants_enabled_locales" ADD VALUE 'om' BEFORE 'pl';
  ALTER TYPE "public"."enum_tenants_default_locale" ADD VALUE 'ff' BEFORE 'fr';
  ALTER TYPE "public"."enum_tenants_default_locale" ADD VALUE 'om' BEFORE 'pl';`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  CREATE TYPE "public"."_locales" AS ENUM('am', 'ar', 'de', 'en', 'es', 'fi', 'fil', 'fr', 'hi', 'hr', 'ht', 'ko', 'km', 'ne', 'pl', 'pt', 'ru', 'so', 'sw', 'uk', 'vi', 'yue', 'zh-Hans', 'zh-Hant');
  ...
  CREATE TYPE "public"."enum_tenants_enabled_locales" AS ENUM('am', 'ar', 'de', 'en', 'es', 'fi', 'fil', 'fr', 'hi', 'hr', 'ht', 'ko', 'km', 'ne', 'pl', 'pt', 'ru', 'so', 'sw', 'uk', 'vi', 'yue', 'zh-Hans', 'zh-Hant');
  ...
  CREATE TYPE "public"."enum_tenants_default_locale" AS ENUM('am', 'ar', 'de', 'en', 'es', 'fi', 'fil', 'fr', 'hi', 'hr', 'ht', 'ko', 'km', 'ne', 'pl', 'pt', 'ru', 'so', 'sw', 'uk', 'vi', 'yue', 'zh-Hans', 'zh-Hant');
