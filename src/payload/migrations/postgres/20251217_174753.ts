...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
    ...
    ADD CONSTRAINT "rds_search_facets_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."rds" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "rds_search_facets_locales"
    ADD CONSTRAINT "rds_search_facets_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."rds_search_facets" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v_version_search_facets"
    ADD CONSTRAINT "_rds_v_version_search_facets_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_rds_v" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v_version_search_facets_locales"
    ADD CONSTRAINT "_rds_v_version_search_facets_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_rds_v_version_search_facets" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;
