...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
    ...
    CREATE TYPE "public"."enum_tenants_enabled_locales" AS ENUM(
      'am',
      'ar',
      'de',
      'en',
    ...
    CREATE TYPE "public"."enum_tenants_default_locale" AS ENUM(
      'am',
      'ar',
      'de',
      'en',
    ...
    ADD CONSTRAINT "users_roles_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."users" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "users_tenants_roles"
    ADD CONSTRAINT "users_tenants_roles_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."users_tenants" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "users_tenants"
    ADD CONSTRAINT "users_tenants_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants" ("id") ON DELETE SET NULL ON UPDATE NO ACTION;

    ALTER TABLE "users_tenants"
    ADD CONSTRAINT "users_tenants_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."users" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "users_sessions"
    ADD CONSTRAINT "users_sessions_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."users" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "tenants_trusted_domains"
    ADD CONSTRAINT "tenants_trusted_domains_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."tenants" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "tenants_enabled_locales"
    ADD CONSTRAINT "tenants_enabled_locales_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."tenants" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "tenant_media"
    ADD CONSTRAINT "tenant_media_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants" ("id") ON DELETE SET NULL ON UPDATE NO ACTION;

    ALTER TABLE "rds_common_alert"
    ADD CONSTRAINT "rds_common_alert_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."rds" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "rds_common_data_providers"
    ADD CONSTRAINT "rds_common_data_providers_logo_id_tenant_media_id_fk" FOREIGN KEY ("logo_id") REFERENCES "public"."tenant_media" ("id") ON DELETE SET NULL ON UPDATE NO ACTION;

    ALTER TABLE "rds_common_data_providers"
    ADD CONSTRAINT "rds_common_data_providers_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."rds" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "rds_header_custom_menu"
    ADD CONSTRAINT "rds_header_custom_menu_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."rds" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "rds_footer_custom_menu"
    ADD CONSTRAINT "rds_footer_custom_menu_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."rds" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "rds_suggestions"
    ADD CONSTRAINT "rds_suggestions_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."rds" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "rds_topics_list_subtopics"
    ADD CONSTRAINT "rds_topics_list_subtopics_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."rds_topics_list" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "rds_topics_list"
    ADD CONSTRAINT "rds_topics_list_image_id_tenant_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."tenant_media" ("id") ON DELETE SET NULL ON UPDATE NO ACTION;

    ALTER TABLE "rds_topics_list"
    ADD CONSTRAINT "rds_topics_list_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."rds" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "rds_search_search_settings_radius_select_values"
    ADD CONSTRAINT "rds_search_search_settings_radius_select_values_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."rds" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "rds_new_layout_callouts_options"
    ADD CONSTRAINT "rds_new_layout_callouts_options_custom_img_id_tenant_media_id_fk" FOREIGN KEY ("custom_img_id") REFERENCES "public"."tenant_media" ("id") ON DELETE SET NULL ON UPDATE NO ACTION;

    ALTER TABLE "rds_new_layout_callouts_options"
    ADD CONSTRAINT "rds_new_layout_callouts_options_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."rds" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "rds"
    ADD CONSTRAINT "rds_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants" ("id") ON DELETE SET NULL ON UPDATE NO ACTION;

    ALTER TABLE "rds"
    ADD CONSTRAINT "rds_brand_logo_id_tenant_media_id_fk" FOREIGN KEY ("brand_logo_id") REFERENCES "public"."tenant_media" ("id") ON DELETE SET NULL ON UPDATE NO ACTION;

    ALTER TABLE "rds"
    ADD CONSTRAINT "rds_brand_favicon_id_tenant_media_id_fk" FOREIGN KEY ("brand_favicon_id") REFERENCES "public"."tenant_media" ("id") ON DELETE SET NULL ON UPDATE NO ACTION;

    ALTER TABLE "rds"
    ADD CONSTRAINT "rds_brand_hero_id_tenant_media_id_fk" FOREIGN KEY ("brand_hero_id") REFERENCES "public"."tenant_media" ("id") ON DELETE SET NULL ON UPDATE NO ACTION;

    ALTER TABLE "rds"
    ADD CONSTRAINT "rds_brand_open_graph_id_tenant_media_id_fk" FOREIGN KEY ("brand_open_graph_id") REFERENCES "public"."tenant_media" ("id") ON DELETE SET NULL ON UPDATE NO ACTION;

    ALTER TABLE "rds"
    ADD CONSTRAINT "rds_new_layout_hero_id_tenant_media_id_fk" FOREIGN KEY ("new_layout_hero_id") REFERENCES "public"."tenant_media" ("id") ON DELETE SET NULL ON UPDATE NO ACTION;

    ALTER TABLE "rds"
    ADD CONSTRAINT "rds_new_layout_logo_id_tenant_media_id_fk" FOREIGN KEY ("new_layout_logo_id") REFERENCES "public"."tenant_media" ("id") ON DELETE SET NULL ON UPDATE NO ACTION;

    ALTER TABLE "rds_locales"
    ADD CONSTRAINT "rds_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."rds" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v_version_common_alert"
    ADD CONSTRAINT "_rds_v_version_common_alert_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_rds_v" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v_version_common_data_providers"
    ADD CONSTRAINT "_rds_v_version_common_data_providers_logo_id_tenant_media_id_fk" FOREIGN KEY ("logo_id") REFERENCES "public"."tenant_media" ("id") ON DELETE SET NULL ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v_version_common_data_providers"
    ADD CONSTRAINT "_rds_v_version_common_data_providers_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_rds_v" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v_version_header_custom_menu"
    ADD CONSTRAINT "_rds_v_version_header_custom_menu_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_rds_v" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v_version_footer_custom_menu"
    ADD CONSTRAINT "_rds_v_version_footer_custom_menu_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_rds_v" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v_version_suggestions"
    ADD CONSTRAINT "_rds_v_version_suggestions_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_rds_v" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v_version_topics_list_subtopics"
    ADD CONSTRAINT "_rds_v_version_topics_list_subtopics_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_rds_v_version_topics_list" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v_version_topics_list"
    ADD CONSTRAINT "_rds_v_version_topics_list_image_id_tenant_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."tenant_media" ("id") ON DELETE SET NULL ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v_version_topics_list"
    ADD CONSTRAINT "_rds_v_version_topics_list_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_rds_v" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v_version_search_search_settings_radius_select_values"
    ADD CONSTRAINT "_rds_v_version_search_search_settings_radius_select_values_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_rds_v" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v_version_new_layout_callouts_options"
    ADD CONSTRAINT "_rds_v_version_new_layout_callouts_options_custom_img_id_tenant_media_id_fk" FOREIGN KEY ("custom_img_id") REFERENCES "public"."tenant_media" ("id") ON DELETE SET NULL ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v_version_new_layout_callouts_options"
    ADD CONSTRAINT "_rds_v_version_new_layout_callouts_options_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_rds_v" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v"
    ADD CONSTRAINT "_rds_v_parent_id_rds_id_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."rds" ("id") ON DELETE SET NULL ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v"
    ADD CONSTRAINT "_rds_v_version_tenant_id_tenants_id_fk" FOREIGN KEY ("version_tenant_id") REFERENCES "public"."tenants" ("id") ON DELETE SET NULL ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v"
    ADD CONSTRAINT "_rds_v_version_brand_logo_id_tenant_media_id_fk" FOREIGN KEY ("version_brand_logo_id") REFERENCES "public"."tenant_media" ("id") ON DELETE SET NULL ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v"
    ADD CONSTRAINT "_rds_v_version_brand_favicon_id_tenant_media_id_fk" FOREIGN KEY ("version_brand_favicon_id") REFERENCES "public"."tenant_media" ("id") ON DELETE SET NULL ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v"
    ADD CONSTRAINT "_rds_v_version_brand_hero_id_tenant_media_id_fk" FOREIGN KEY ("version_brand_hero_id") REFERENCES "public"."tenant_media" ("id") ON DELETE SET NULL ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v"
    ADD CONSTRAINT "_rds_v_version_brand_open_graph_id_tenant_media_id_fk" FOREIGN KEY ("version_brand_open_graph_id") REFERENCES "public"."tenant_media" ("id") ON DELETE SET NULL ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v"
    ADD CONSTRAINT "_rds_v_version_new_layout_hero_id_tenant_media_id_fk" FOREIGN KEY ("version_new_layout_hero_id") REFERENCES "public"."tenant_media" ("id") ON DELETE SET NULL ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v"
    ADD CONSTRAINT "_rds_v_version_new_layout_logo_id_tenant_media_id_fk" FOREIGN KEY ("version_new_layout_logo_id") REFERENCES "public"."tenant_media" ("id") ON DELETE SET NULL ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v_locales"
    ADD CONSTRAINT "_rds_v_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_rds_v" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;
    ...
    ALTER TABLE "payload_locked_documents_rels"
    ADD CONSTRAINT "payload_locked_documents_rels_tenants_fk" FOREIGN KEY ("tenants_id") REFERENCES "public"."tenants" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "payload_locked_documents_rels"
    ADD CONSTRAINT "payload_locked_documents_rels_tenant_media_fk" FOREIGN KEY ("tenant_media_id") REFERENCES "public"."tenant_media" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "payload_locked_documents_rels"
    ADD CONSTRAINT "payload_locked_documents_rels_resource_directories_fk" FOREIGN KEY ("rds_id") REFERENCES "public"."rds" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;
