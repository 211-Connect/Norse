...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
    ...
    ADD COLUMN "oc_id" varchar;

    ALTER TABLE "oc_schemas_custom_attributes"
    ADD CONSTRAINT "oc_schemas_custom_attributes_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."oc_schemas" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "oc_schemas_custom_attributes_locales"
    ADD CONSTRAINT "oc_schemas_custom_attributes_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."oc_schemas_custom_attributes" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "oc_schemas"
    ADD CONSTRAINT "oc_schemas_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."oc" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "oc"
    ADD CONSTRAINT "oc_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants" ("id") ON DELETE SET NULL ON UPDATE NO ACTION;

    ALTER TABLE "_oc_v_version_schemas_custom_attributes"
    ADD CONSTRAINT "_oc_v_version_schemas_custom_attributes_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_oc_v_version_schemas" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "_oc_v_version_schemas_custom_attributes_locales"
    ADD CONSTRAINT "_oc_v_version_schemas_custom_attributes_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_oc_v_version_schemas_custom_attributes" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "_oc_v_version_schemas"
    ADD CONSTRAINT "_oc_v_version_schemas_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_oc_v" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "_oc_v"
    ADD CONSTRAINT "_oc_v_parent_id_oc_id_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."oc" ("id") ON DELETE SET NULL ON UPDATE NO ACTION;

    ALTER TABLE "_oc_v"
    ADD CONSTRAINT "_oc_v_version_tenant_id_tenants_id_fk" FOREIGN KEY ("version_tenant_id") REFERENCES "public"."tenants" ("id") ON DELETE SET NULL ON UPDATE NO ACTION;
    ...
    ALTER TABLE "payload_locked_documents_rels"
    ADD CONSTRAINT "payload_locked_documents_rels_orchestration_config_fk" FOREIGN KEY ("oc_id") REFERENCES "public"."oc" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;
...
export async function down({
  ...
  await db.execute(sql`
    ...
    ALTER TABLE "payload_locked_documents_rels"
    DROP CONSTRAINT "payload_locked_documents_rels_orchestration_config_fk";

    DROP INDEX "payload_locked_documents_rels_oc_id_idx";

    ALTER TABLE "rds_custom_attributes_attributes"
    ADD CONSTRAINT "rds_custom_attributes_attributes_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."rds" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "rds_custom_attributes_attributes_locales"
    ADD CONSTRAINT "rds_custom_attributes_attributes_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."rds_custom_attributes_attributes" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v_version_custom_attributes_attributes"
    ADD CONSTRAINT "_rds_v_version_custom_attributes_attributes_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_rds_v" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "_rds_v_version_custom_attributes_attributes_locales"
    ADD CONSTRAINT "_rds_v_version_custom_attributes_attributes_locales_paren_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_rds_v_version_custom_attributes_attributes" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;
