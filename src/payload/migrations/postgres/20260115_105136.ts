...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TYPE "public"."_locales" ADD VALUE 'fa' BEFORE 'fi';
  ALTER TYPE "public"."_locales" ADD VALUE 'or' BEFORE 'pl';
  ALTER TYPE "public"."_locales" ADD VALUE 'ps' BEFORE 'pt';
  ALTER TYPE "public"."_locales" ADD VALUE 'prs' BEFORE 'pt';
  ALTER TYPE "public"."enum_tenants_enabled_locales" ADD VALUE 'fa' BEFORE 'fi';
  ALTER TYPE "public"."enum_tenants_enabled_locales" ADD VALUE 'or' BEFORE 'pl';
  ALTER TYPE "public"."enum_tenants_enabled_locales" ADD VALUE 'ps' BEFORE 'pt';
  ALTER TYPE "public"."enum_tenants_enabled_locales" ADD VALUE 'prs' BEFORE 'pt';
  ALTER TYPE "public"."enum_tenants_default_locale" ADD VALUE 'fa' BEFORE 'fi';
  ALTER TYPE "public"."enum_tenants_default_locale" ADD VALUE 'or' BEFORE 'pl';
  ALTER TYPE "public"."enum_tenants_default_locale" ADD VALUE 'ps' BEFORE 'pt';
  ALTER TYPE "public"."enum_tenants_default_locale" ADD VALUE 'prs' BEFORE 'pt';`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  CREATE TYPE "public"."_locales" AS ENUM('am', 'ar', 'de', 'en', 'es', 'fi', 'fil', 'ff', 'fr', 'hi', 'hr', 'ht', 'ko', 'km', 'ne', 'om', 'pl', 'pt', 'ru', 'so', 'sw', 'uk', 'vi', 'yue', 'zh-Hans', 'zh-Hant');
  ...
  CREATE TYPE "public"."enum_tenants_enabled_locales" AS ENUM('am', 'ar', 'de', 'en', 'es', 'fi', 'fil', 'ff', 'fr', 'hi', 'hr', 'ht', 'ko', 'km', 'ne', 'om', 'pl', 'pt', 'ru', 'so', 'sw', 'uk', 'vi', 'yue', 'zh-Hans', 'zh-Hant');
  ...
  CREATE TYPE "public"."enum_tenants_default_locale" AS ENUM('am', 'ar', 'de', 'en', 'es', 'fi', 'fil', 'ff', 'fr', 'hi', 'hr', 'ht', 'ko', 'km', 'ne', 'om', 'pl', 'pt', 'ru', 'so', 'sw', 'uk', 'vi', 'yue', 'zh-Hans', 'zh-Hant');
