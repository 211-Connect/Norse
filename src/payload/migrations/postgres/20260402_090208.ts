...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TYPE "public"."enum_left_col_items_component_id" ADD VALUE 'organizationUrl' BEFORE 'email';
  ALTER TYPE "public"."enum_right_col_items_component_id" ADD VALUE 'organizationUrl' BEFORE 'email';
  ALTER TYPE "public"."enum__left_col_v_items_component_id" ADD VALUE 'organizationUrl' BEFORE 'email';
  ALTER TYPE "public"."enum__right_col_v_items_component_id" ADD VALUE 'organizationUrl' BEFORE 'email';`)
}
