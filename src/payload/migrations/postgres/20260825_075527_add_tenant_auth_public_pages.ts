...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_tenants_auth_public_pages" AS ENUM('home', 'search-results', 'resource-detail', 'favorites-list');
  ...
  ALTER TABLE "tenants_auth_public_pages" ADD CONSTRAINT "tenants_auth_public_pages_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."tenants"("id") ON DELETE cascade ON UPDATE no action;
