...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TYPE "public"."enum_rds_search_card_layout_component_id" ADD VALUE 'attribution' BEFORE 'badges';
  ALTER TYPE "public"."enum__rds_v_version_search_card_layout_component_id" ADD VALUE 'attribution' BEFORE 'badges';`)
}
