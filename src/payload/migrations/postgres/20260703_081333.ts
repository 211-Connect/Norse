...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TYPE "public"."enum_left_col_items_component_id" ADD VALUE 'alert' BEFORE 'facets';
  ALTER TYPE "public"."enum_right_col_items_component_id" ADD VALUE 'alert' BEFORE 'facets';
  ALTER TYPE "public"."enum_rds_search_card_layout_component_id" ADD VALUE 'alert';
  ALTER TYPE "public"."enum__left_col_v_items_component_id" ADD VALUE 'alert' BEFORE 'facets';
  ALTER TYPE "public"."enum__right_col_v_items_component_id" ADD VALUE 'alert' BEFORE 'facets';
  ALTER TYPE "public"."enum__rds_v_version_search_card_layout_component_id" ADD VALUE 'alert';`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_left_col_items_component_id" AS ENUM('badges', 'resourceName', 'serviceName', 'locationName', 'locationNameSubtitle', 'address', 'transportation', 'accessibility', 'eligibility', 'requiredDocuments', 'hours', 'contacts', 'phoneNumbers', 'website', 'organizationUrl', 'email', 'languages', 'interpretationServices', 'applicationProcess', 'fees', 'serviceArea', 'description', 'categories', 'lastAssured', 'attribution', 'map', 'getDirections', 'organization', 'quality', 'facets', 'separator', 'customAttribute');
  ...
  CREATE TYPE "public"."enum_rds_search_card_layout_component_id" AS ENUM('attribution', 'badges', 'resourceName', 'serviceName', 'eligibility', 'applicationProcess', 'locationName', 'locationNameSubtitle', 'address', 'phone', 'website', 'description', 'categories', 'actionButtons', 'separator', 'customAttribute');
  ...
  CREATE TYPE "public"."enum__rds_v_version_search_card_layout_component_id" AS ENUM('attribution', 'badges', 'resourceName', 'serviceName', 'eligibility', 'applicationProcess', 'locationName', 'locationNameSubtitle', 'address', 'phone', 'website', 'description', 'categories', 'actionButtons', 'separator', 'customAttribute');
