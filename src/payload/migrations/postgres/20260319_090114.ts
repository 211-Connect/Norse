...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
    CREATE TYPE "public"."enum_left_col_items_component_id" AS ENUM(
      'badges',
      'resourceName',
      'serviceName',
      'address',
    ...
    CREATE TYPE "public"."enum_right_col_items_component_id" AS ENUM(
      'badges',
      'resourceName',
      'serviceName',
      'address',
    ...
    CREATE TYPE "public"."enum__left_col_v_items_component_id" AS ENUM(
      'badges',
      'resourceName',
      'serviceName',
      'address',
    ...
    CREATE TYPE "public"."enum__right_col_v_items_component_id" AS ENUM(
      'badges',
      'resourceName',
      'serviceName',
      'address',
    ...
    ALTER TABLE "rds"
    ADD COLUMN "resource_use_custom_layout" boolean DEFAULT FALSE;

    ALTER TABLE "_rds_v"
    ADD COLUMN "version_resource_use_custom_layout" boolean DEFAULT FALSE;

    ALTER TABLE "left_col_items"
    ADD CONSTRAINT "left_col_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."left_col" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "left_col_items_locales"
    ADD CONSTRAINT "left_col_items_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."left_col_items" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "left_col"
    ADD CONSTRAINT "left_col_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."rds" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "right_col_items"
    ADD CONSTRAINT "right_col_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."right_col" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "right_col_items_locales"
    ADD CONSTRAINT "right_col_items_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."right_col_items" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "right_col"
    ADD CONSTRAINT "right_col_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."rds" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "_left_col_v_items"
    ADD CONSTRAINT "_left_col_v_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_left_col_v" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "_left_col_v_items_locales"
    ADD CONSTRAINT "_left_col_v_items_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_left_col_v_items" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "_left_col_v"
    ADD CONSTRAINT "_left_col_v_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_rds_v" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "_right_col_v_items"
    ADD CONSTRAINT "_right_col_v_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_right_col_v" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "_right_col_v_items_locales"
    ADD CONSTRAINT "_right_col_v_items_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_right_col_v_items" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

    ALTER TABLE "_right_col_v"
    ADD CONSTRAINT "_right_col_v_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_rds_v" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;
...
export async function down({
  ...
  await db.execute(sql`
    ...
    ALTER TABLE "rds"
    DROP COLUMN "resource_use_custom_layout";

    ALTER TABLE "_rds_v"
    DROP COLUMN "version_resource_use_custom_layout";
