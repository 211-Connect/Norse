...
export default function InternalErrorIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      ...
      />
      <path fill="#efefef" d="M271.609 150h16v16h-16z" opacity={0.4} />
      <path fill="#efefef" d="M294.609 150h16v16h-16z" opacity={0.8} />
      <path fill="#efefef" d="M317.609 150h16v16h-16z" />
      <path fill="#efefef" d="M271.609 251h16v16h-16z" opacity={0.4} />
      <path fill="#efefef" d="M294.609 251h16v16h-16z" opacity={0.8} />
      <path fill="#efefef" d="M317.609 251h16v16h-16z" />
      <path fill="#efefef" d="M271.609 352h16v16h-16z" opacity={0.4} />
      <path fill="#efefef" d="M294.609 352h16v16h-16z" opacity={0.8} />
      <path fill="#efefef" d="M317.609 352h16v16h-16z" />
